...
package dev.kingtux.batterymonitor.watch.presentation
...
fun BatteryLevel(device: SharedDevice, numberOfDevices: Int = 1) {
    ...
    val image = when (device.deviceType) {
        DeviceType.Watch -> {
            dev.kingtux.batterymonitor.watch.R.drawable.watch
        }

        DeviceType.Phone -> {
            dev.kingtux.batterymonitor.watch.R.drawable.cellphone
        }

        DeviceType.Headphones -> {
            dev.kingtux.batterymonitor.watch.R.drawable.headphones
        }

        DeviceType.Glasses -> {
            dev.kingtux.batterymonitor.watch.R.drawable.glasses
        }

        DeviceType.Earbuds -> {
            dev.kingtux.batterymonitor.watch.R.drawable.earbuds
        }

        DeviceType.Other -> {
            dev.kingtux.batterymonitor.watch.R.drawable.bluetooth
        }
    }
    Box(
        modifier = Modifier
